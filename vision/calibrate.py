...
# To calibrate:
# Run, show the calibration chessboard to the camera, press space to capture. Capture around 50 pictures and press q, and calibration will commence.
# Outputs calibration_chessboard.yaml.
...
def main():
    ...
    while True:
        ...
        if cv2.waitKey(1) & 0xFF == 32:
            cv2.imwrite(f"pictures/{index}.png", frame)
            print(index)
            index += 1
